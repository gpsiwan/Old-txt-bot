...
# API Configuration
API_ID = int(os.environ.get("API_ID", "21938491"))
...
OWNER_ID = int(os.environ.get("OWNER_ID", "7068902812"))
ADMINS = [int(x) for x in os.environ.get("ADMINS", "7068902812").split()]  # Default to owner ID
